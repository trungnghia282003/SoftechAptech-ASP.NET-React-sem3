...
namespace OA.Api.Migrations
{
    ...
    [Migration("20240214123245_AddColummItemTable")]
    partial class AddColummItemTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OA.Entities.Item", b =>
                {
                    ...
                    b.Property<byte[]>("ImageFile1")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("ImageFile2")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("ImageFile3")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("ImageFile4")
                        .HasColumnType("varbinary(max)");
